...
const ACTIVE_FEATURE_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "ניהול סטטוס מיכלי בצק",
    body: "עדכון מהיר: לחצו על הכרטיסייה כדי לעדכן את כמות מיכלי הבצק לפי מיקום (פיצה / מקפיא / מקרר). אייקון השעון פותח היסטוריה לפי ימים עם סה״כ סוף יום.",
  },
  {
