...
📄 טיפול בתעודות משלוח (ללא מחירים ליחידה):
- אם המסמך הוא תעודת משלוח (תעודת משלוח / ת.מ. / Delivery Note) ואין בו מחירים ליחידה — חלץ במדויק את שמות הפריטים והכמויות.
- אם בשורה מופיע סה"כ כספי לפריט (total_price) עם quantity אך ללא unit_price — חשב לבד: unit_price = total_price / quantity, ו-base_unit_price = unit_price, discount=null.
- אם אין כלל מחיר בשורה — השאר את base_unit_price, unit_price, total_price כ-null. אל תמציא מחירים ואל תשתמש במחירים מהקטלוג.
