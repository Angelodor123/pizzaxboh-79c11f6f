...
- התעלם לחלוטין וסנן החוצה פריטי אריזה/לוגיסטיקה: "משטח יורו פלסטיק", "משטח עץ", "משטח", "פלטה", "ארגז ריק", "מארז החזרה", "פיקדון", "בקבוקים ריקים", "Pallet", "Crate", "Deposit".
- פריטים אלה לא נכנסים למערך items. אל תכלול אותם בכלל בפלט.
- אם כל המסמך הוא פריט לוגיסטי בלבד — החזר items=[].
