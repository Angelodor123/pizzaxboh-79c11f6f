  ...
  public: {
    Tables: {
      ...
      container_weights: {
        ...
        Relationships: [
          {
            foreignKeyName: "container_weights_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      delivery_exceptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_exceptions_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "delivery_exceptions_invoice_id_fkey"
            columns: ["invoice_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "delivery_exceptions_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "delivery_exceptions_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "delivery_exceptions_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "suppliers"
            referencedColumns: ["id"]
      ...
      shift_feed: {
        ...
        Relationships: [
          {
            foreignKeyName: "shift_feed_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
      ...
      shift_feed_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "shift_feed_comments_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
